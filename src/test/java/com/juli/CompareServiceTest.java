...
import com.juli.service.CompareService;
...
public class CompareServiceTest {
    ...
    public void shouldFailWhenDocumentIdDoesNotExist() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
    ...
    @Test(expected = InvalidInputDataException.class)
    public void shouldFailWhenBothSidesAreMissing() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
    ...
    @Test(expected = InvalidInputDataException.class)
    public void shouldFailWhenLeftSideIsMissing() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
        when(repository.findById(sampleId))
            .thenReturn(Optional.of(Request.builder()
                .id(sampleId)
                .right(sampleBase64)
    ...
    @Test(expected = InvalidInputDataException.class)
    public void shouldFailWhenRightSideIsMissing() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
        when(repository.findById(sampleId))
            .thenReturn(Optional.of(Request.builder()
                .id(sampleId)
                .left(sampleBase64)
    ...
    @Test
    public void shouldReturnEqualwhenBothSidesAreEqual() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
        when(repository.findById(sampleId))
    ...
    @Test
    public void shouldReturnDifferentSize() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
        when(repository.findById(sampleId))
            .thenReturn(Optional.of(Request.builder().id(sampleId).left("ewogIndhZXMiIDogInllcyIKfQ==").right("ewogIndhZXMiIDogIk5vIgp9").build()));
    ...
    @Test
    public void shouldReturnDifferentOffset() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
        when(repository.findById(sampleId))
    ...
    @Test
    public void shouldReturnDifferentOffsetAndReturnDiffOffsetArray() throws DocumentNotFoundException, InvalidInputDataException, Base64ValidationFailedException {
        when(repository.findById(sampleId))
            .thenReturn(Optional.of(Request.builder().id(sampleId).left("bXlkb21haW4uY29tOmRueURucz").right("bXlkb21haW4uY29tOmR5bkRucz").build()));
